...
public class OverseerServlet extends HttpServlet {
    ...
    private static final Logger log = LoggerFactory.getLogger(OverseerServlet.class);
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Calendar calendar = messages.get(0).getTimestamp();
        ...
        try (PrintWriter out = resp.getWriter()) {
            ...
            for (History history : messages) {
                calendar.setTime(history.getTimestamp().getTime());
